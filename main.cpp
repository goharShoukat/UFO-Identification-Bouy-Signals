...
std::vector<Position> compute_ufo_positions(
        std::vector<RadarSingleData> radar1_data,
        std::vector<RadarSingleData> radar2_data,
    ...
    std::vector<Position> ufo_positions;//value returned by the function
...
for (int j = 0; j < size_data; j++)
{
   ...
   for (int i = 0; i < size_data; i++){
       ...
       //Code as per usual begins
        ...
        pdd intersection_point = lineLineIntersection(A, B, C, D);
...
int main() {
    std::vector<RadarSingleData> radar1_data; //input from radar 1
    std::vector<RadarSingleData> radar2_data; //input from radar 2
    Position radar2_position = Position(200.0, 2000.0); //position of 0radar 2 relevant to radar 1
    std::vector<Position> ufo_positions;
    ...
    if (vectsize == 0){
    std::cout<<"There is no incoming UFO"<<std::endl;
    }
    ...
    std::cout<<vectsize<<" UFO detected at:"<<std::endl;
        
    std::cout<<"x = "<<ufo_positions[i].x<<" , y = "<<ufo_positions[i].y<<std::endl;
    }
    ...
    vectsize = ufo_positions.size();
    //gives us size of vector and displays 
    std::cout<<vectsize<<" total UFOs detected. There coordinates are as follows: "<<std::endl;
    for (int i = 0; i < vectsize; i++ ){
    std::cout<<i+1<<" UFO detected at:";
    ...
    std::cout<<vectsize<<" total UFOs detected. There coordinates are as follows: "<<std::endl;
    for (int i = 0; i < vectsize; i++ ){
    std::cout<<" UFO detected at:"<<std::endl;
